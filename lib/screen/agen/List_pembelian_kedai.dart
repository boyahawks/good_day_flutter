...
class ListPembelianKedai extends StatefulWidget {
  @override
  State<ListPembelianKedai> createState() => _ListPembelianKedaiinState();
}

class _ListPembelianKedaiinState extends State<ListPembelianKedai> {
  // final GlobalKey _scaffoldKey = new GlobalKey();

  _ListPembelianKedaiinState createState() => _ListPembelianKedaiinState();
  ...
  getDataKonfirmasi() async {
    try {
      ...
      var response = await dio.Dio().post(
        Api.allDataKonfirmasiPembelianGrosir,
        data: formData,
      );
  ...
  aksiFilterDataKonfirmasiPembelian() async {
    ...
    try {
      ...
      var response = await dio.Dio().post(
        Api.gantiStatusPembelianFilterDataGrosir,
        data: formData,
      );
      var data = response.data['data'];
      var status = response.data['status'];
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          flex: 50,
                          child: rowPembelian[0]['status_laporan'] == "0"
                              ? Text(
                                  ": BELUM ACC",
                                  style: TextStyle(
                                      fontSize: 12,
